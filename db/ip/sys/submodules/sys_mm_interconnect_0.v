...
module sys_mm_interconnect_0 (
	...
	wire  [90:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> CPU_data_master_agent:rp_data
	...
	wire  [90:0] rsp_mux_001_src_data;                                                      // rsp_mux_001:src_data -> CPU_instruction_master_agent:rp_data
	...
	wire  [90:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> CPU_debug_mem_slave_agent:cp_data
	...
	wire  [91:0] uart_s1_agent_rf_source_data;                                              // UART_s1_agent:rf_source_data -> UART_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] uart_s1_agent_rsp_fifo_out_data;                                           // UART_s1_agent_rsp_fifo:out_data -> UART_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> UART_s1_agent:cp_valid
	wire  [90:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> UART_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // UART_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> UART_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> UART_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> UART_s1_agent:cp_endofpacket
	wire  [31:0] ram_s2_agent_m0_readdata;                                                  // RAM_s2_translator:uav_readdata -> RAM_s2_agent:m0_readdata
	wire         ram_s2_agent_m0_waitrequest;                                               // RAM_s2_translator:uav_waitrequest -> RAM_s2_agent:m0_waitrequest
	wire         ram_s2_agent_m0_debugaccess;                                               // RAM_s2_agent:m0_debugaccess -> RAM_s2_translator:uav_debugaccess
	wire  [16:0] ram_s2_agent_m0_address;                                                   // RAM_s2_agent:m0_address -> RAM_s2_translator:uav_address
	wire   [3:0] ram_s2_agent_m0_byteenable;                                                // RAM_s2_agent:m0_byteenable -> RAM_s2_translator:uav_byteenable
	wire         ram_s2_agent_m0_read;                                                      // RAM_s2_agent:m0_read -> RAM_s2_translator:uav_read
	wire         ram_s2_agent_m0_readdatavalid;                                             // RAM_s2_translator:uav_readdatavalid -> RAM_s2_agent:m0_readdatavalid
	wire         ram_s2_agent_m0_lock;                                                      // RAM_s2_agent:m0_lock -> RAM_s2_translator:uav_lock
	wire  [31:0] ram_s2_agent_m0_writedata;                                                 // RAM_s2_agent:m0_writedata -> RAM_s2_translator:uav_writedata
	wire         ram_s2_agent_m0_write;                                                     // RAM_s2_agent:m0_write -> RAM_s2_translator:uav_write
	wire   [2:0] ram_s2_agent_m0_burstcount;                                                // RAM_s2_agent:m0_burstcount -> RAM_s2_translator:uav_burstcount
	wire         ram_s2_agent_rf_source_valid;                                              // RAM_s2_agent:rf_source_valid -> RAM_s2_agent_rsp_fifo:in_valid
	wire  [91:0] ram_s2_agent_rf_source_data;                                               // RAM_s2_agent:rf_source_data -> RAM_s2_agent_rsp_fifo:in_data
	wire         ram_s2_agent_rf_source_ready;                                              // RAM_s2_agent_rsp_fifo:in_ready -> RAM_s2_agent:rf_source_ready
	wire         ram_s2_agent_rf_source_startofpacket;                                      // RAM_s2_agent:rf_source_startofpacket -> RAM_s2_agent_rsp_fifo:in_startofpacket
	wire         ram_s2_agent_rf_source_endofpacket;                                        // RAM_s2_agent:rf_source_endofpacket -> RAM_s2_agent_rsp_fifo:in_endofpacket
	wire         ram_s2_agent_rsp_fifo_out_valid;                                           // RAM_s2_agent_rsp_fifo:out_valid -> RAM_s2_agent:rf_sink_valid
	wire  [91:0] ram_s2_agent_rsp_fifo_out_data;                                            // RAM_s2_agent_rsp_fifo:out_data -> RAM_s2_agent:rf_sink_data
	wire         ram_s2_agent_rsp_fifo_out_ready;                                           // RAM_s2_agent:rf_sink_ready -> RAM_s2_agent_rsp_fifo:out_ready
	wire         ram_s2_agent_rsp_fifo_out_startofpacket;                                   // RAM_s2_agent_rsp_fifo:out_startofpacket -> RAM_s2_agent:rf_sink_startofpacket
	wire         ram_s2_agent_rsp_fifo_out_endofpacket;                                     // RAM_s2_agent_rsp_fifo:out_endofpacket -> RAM_s2_agent:rf_sink_endofpacket
	wire         cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> RAM_s2_agent:cp_valid
	wire  [90:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> RAM_s2_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // RAM_s2_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [3:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> RAM_s2_agent:cp_channel
	wire         cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> RAM_s2_agent:cp_startofpacket
	wire         cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> RAM_s2_agent:cp_endofpacket
	...
	wire  [90:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> RAM_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // RAM_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> RAM_s1_agent:cp_channel
	...
	wire  [90:0] cpu_debug_mem_slave_agent_rp_data;                                         // CPU_debug_mem_slave_agent:rp_data -> router_002:sink_data
	...
	wire         uart_s1_agent_rp_valid;                                                    // UART_s1_agent:rp_valid -> router_003:sink_valid
	wire  [90:0] uart_s1_agent_rp_data;                                                     // UART_s1_agent:rp_data -> router_003:sink_data
	wire         uart_s1_agent_rp_ready;                                                    // router_003:sink_ready -> UART_s1_agent:rp_ready
	wire         uart_s1_agent_rp_startofpacket;                                            // UART_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire         uart_s1_agent_rp_endofpacket;                                              // UART_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire         ram_s2_agent_rp_valid;                                                     // RAM_s2_agent:rp_valid -> router_004:sink_valid
	wire  [90:0] ram_s2_agent_rp_data;                                                      // RAM_s2_agent:rp_data -> router_004:sink_data
	wire         ram_s2_agent_rp_ready;                                                     // router_004:sink_ready -> RAM_s2_agent:rp_ready
	wire         ram_s2_agent_rp_startofpacket;                                             // RAM_s2_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire         ram_s2_agent_rp_endofpacket;                                               // RAM_s2_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [90:0] ram_s1_agent_rp_data;                                                      // RAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [90:0] cmd_demux_001_src1_data;                                                   // cmd_demux_001:src1_data -> cmd_mux_003:sink0_data
	...
	wire  [90:0] rsp_demux_003_src0_data;                                                   // rsp_demux_003:src0_data -> rsp_mux_001:sink1_data
	...
	wire         uart_s1_agent_rdata_fifo_src_valid;                                        // UART_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] uart_s1_agent_rdata_fifo_src_data;                                         // UART_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         uart_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_001:in_0_ready -> UART_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> UART_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> UART_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                         // UART_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> UART_s1_agent:rdata_fifo_sink_error
	wire         ram_s2_agent_rdata_fifo_src_valid;                                         // RAM_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire  [33:0] ram_s2_agent_rdata_fifo_src_data;                                          // RAM_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire         ram_s2_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_002:in_0_ready -> RAM_s2_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> RAM_s2_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> RAM_s2_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_002_out_0_ready;                                         // RAM_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire   [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> RAM_s2_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                         //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ram_s2_agent_m0_address),               // avalon_universal_slave_0.address
		.uav_burstcount         (ram_s2_agent_m0_burstcount),            //                         .burstcount
		.uav_read               (ram_s2_agent_m0_read),                  //                         .read
		.uav_write              (ram_s2_agent_m0_write),                 //                         .write
		.uav_waitrequest        (ram_s2_agent_m0_waitrequest),           //                         .waitrequest
		.uav_readdatavalid      (ram_s2_agent_m0_readdatavalid),         //                         .readdatavalid
		.uav_byteenable         (ram_s2_agent_m0_byteenable),            //                         .byteenable
		.uav_readdata           (ram_s2_agent_m0_readdata),              //                         .readdata
		.uav_writedata          (ram_s2_agent_m0_writedata),             //                         .writedata
		.uav_lock               (ram_s2_agent_m0_lock),                  //                         .lock
		.uav_debugaccess        (ram_s2_agent_m0_debugaccess),           //                         .debugaccess
		...
		.av_byteenable          (RAM_s2_byteenable),                     //                         .byteenable
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                           //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
		.m0_address              (ram_s2_agent_m0_address),                 //              m0.address
		.m0_burstcount           (ram_s2_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (ram_s2_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (ram_s2_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (ram_s2_agent_m0_lock),                    //                .lock
		.m0_readdata             (ram_s2_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (ram_s2_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (ram_s2_agent_m0_read),                    //                .read
		.m0_waitrequest          (ram_s2_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (ram_s2_agent_m0_writedata),               //                .writedata
		.m0_write                (ram_s2_agent_m0_write),                   //                .write
		.rp_endofpacket          (ram_s2_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (ram_s2_agent_rp_ready),                   //                .ready
		.rp_valid                (ram_s2_agent_rp_valid),                   //                .valid
		.rp_data                 (ram_s2_agent_rp_data),                    //                .data
		.rp_startofpacket        (ram_s2_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (ram_s2_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (ram_s2_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (ram_s2_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (ram_s2_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (ram_s2_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (ram_s2_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (ram_s2_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (ram_s2_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (ram_s2_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (ram_s2_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),       //                .error
		.rdata_fifo_src_ready    (ram_s2_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ram_s2_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (ram_s2_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ram_s2_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                           //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),   // clk_reset.reset
		.in_data           (ram_s2_agent_rf_source_data),             //        in.data
		.in_valid          (ram_s2_agent_rf_source_valid),            //          .valid
		.in_ready          (ram_s2_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ram_s2_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ram_s2_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ram_s2_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ram_s2_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ram_s2_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ram_s2_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ram_s2_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                   // (terminated)
		.csr_read          (1'b0),                                    // (terminated)
		.csr_write         (1'b0),                                    // (terminated)
		.csr_readdata      (),                                        // (terminated)
	...
	sys_mm_interconnect_0_router_003 router_003 (
	...
	sys_mm_interconnect_0_router_003 router_004 (
		.sink_ready         (ram_s2_agent_rp_ready),                 //      sink.ready
		.sink_valid         (ram_s2_agent_rp_valid),                 //          .valid
		.sink_data          (ram_s2_agent_rp_data),                  //          .data
		.sink_startofpacket (ram_s2_agent_rp_startofpacket),         //          .startofpacket
		.sink_endofpacket   (ram_s2_agent_rp_endofpacket),           //          .endofpacket
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_router_005 router_005 (
	...
	sys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_cmd_demux_001 rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (CPU_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ram_s2_agent_rdata_fifo_src_data),      //     in_0.data
		.in_0_valid     (ram_s2_agent_rdata_fifo_src_valid),     //         .valid
		.in_0_ready     (ram_s2_agent_rdata_fifo_src_ready),     //         .ready
